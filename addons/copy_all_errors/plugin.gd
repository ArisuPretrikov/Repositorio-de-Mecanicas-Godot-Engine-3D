...
## Injeta um botão "Copiar Tudo" no painel de "Erros" do depurador.
## Ao clicar, formata e copia todas as mensagens de erro/aviso para a área de transferência do sistema.
...
func _enter_tree() -> void:
	# A interface do editor pode não estar totalmente pronta, usar Timer para atrasar a busca
