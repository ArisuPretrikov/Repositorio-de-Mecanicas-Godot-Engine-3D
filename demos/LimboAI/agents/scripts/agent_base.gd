...
const MINION_RESOURCE := "res://demos/LimboAI/agents/03_agent_imp.tscn"

# Projectile resource.
const NinjaStar := preload("res://demos/LimboAI/agents/ninja_star/ninja_star.tscn")
const Fireball := preload("res://demos/LimboAI/agents/fireball/fireball.tscn")
