...
func _populate_agent_files(p_path: String = "res://demos/LimboAI/agents/") -> void:
...
func _on_switch_to_game_pressed() -> void:
	get_tree().change_scene_to_file("res://demos/LimboAI/scenes/game.tscn")
