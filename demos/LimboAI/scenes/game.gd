...
const Simple := preload("res://demos/LimboAI/agents/01_agent_melee_simple.tscn")
const Charger := preload("res://demos/LimboAI/agents/02_agent_charger.tscn")
const Imp := preload("res://demos/LimboAI/agents/03_agent_imp.tscn")
const Skirmisher := preload("res://demos/LimboAI/agents/04_agent_skirmisher.tscn")
const Ranged := preload("res://demos/LimboAI/agents/05_agent_ranged.tscn")
const Combo := preload("res://demos/LimboAI/agents/06_agent_melee_combo.tscn")
const Nuanced := preload("res://demos/LimboAI/agents/07_agent_melee_nuanced.tscn")
const Demon := preload("res://demos/LimboAI/agents/08_agent_demon.tscn")
const Summoner := preload("res://demos/LimboAI/agents/09_agent_summoner.tscn")
...
func _on_switch_to_showcase_pressed() -> void:
	get_tree().change_scene_to_file("res://demos/LimboAI/scenes/showcase.tscn")
